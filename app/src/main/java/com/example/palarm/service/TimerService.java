...
import com.example.palarm.activities.MainActivity;
...
public class TimerService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        timers = ((palarm) getApplicationContext()).getTimers();
    ...
    private Notification getNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
            notificationManager.createNotificationChannel(new NotificationChannel(palarm.NOTIFICATION_CHANNEL_TIMERS, "Timers", NotificationManager.IMPORTANCE_LOW));
        ...
        return new NotificationCompat.Builder(this, palarm.NOTIFICATION_CHANNEL_TIMERS)
