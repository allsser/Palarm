...
import com.example.palarm.dialogs.AestheticTimeSheetPickerDialog;
import com.example.palarm.dialogs.TimerDialog;
import com.example.palarm.interfaces.FragmentInstantiator;
import com.example.palarm.utils.ImageUtils;
import com.example.palarm.views.PageIndicatorView;
...
public class HomeFragment extends BaseFragment {
    ...
    public static final String INTENT_ACTION = "com.example.palarm.HomeFragment.INTENT_ACTION";
...
//                new SettingsFragment.Instantiator(getContext())
        ...
        colorAccentSubscription = Aesthetic.Companion.get()
                ...
                .subscribe(integer -> {
                    ...
                    int color = ContextCompat.getColor(getContext(), getAlarmio().getActivityTheme() == com.example.palarm.palarm.THEME_AMOLED ? R.color.textColorPrimary : R.color.textColorPrimaryNight);
